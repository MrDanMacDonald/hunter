...
ActiveRecord::Schema.define(version: 20150418235756) do
  ...
  add_index "comment_hierarchies", ["descendant_id"], name: "comment_desc_udx", using: :btree
